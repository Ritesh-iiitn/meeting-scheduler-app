...
import { Link as LinkIcon, Clock, Calendar, Sparkles, Activity, TrendingUp, Users } from "lucide-react";
    ...
    <div className="max-w-6xl mx-auto opacity-0 animate-fade-in p-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 font-medium mt-1">Welcome back, John. Here's your overview.</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div className="glass-card p-6 rounded-2xl flex items-center justify-between border-slate-200">
          <div>
            <p className="text-slate-500 text-sm font-semibold mb-1 uppercase tracking-wider">Total Bookings</p>
            <h3 className="text-3xl font-bold text-slate-800">128 <span className="text-sm text-green-600 font-semibold ml-2">↑ 12%</span></h3>
          </div>
          <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center border border-blue-100">
            <TrendingUp className="text-blue-600 w-6 h-6" />
          </div>
        </div>
        <div className="glass-card p-6 rounded-2xl flex items-center justify-between animate-stagger-1 border-slate-200">
          <div>
            <p className="text-slate-500 text-sm font-semibold mb-1 uppercase tracking-wider">Active Event Types</p>
            <h3 className="text-3xl font-bold text-slate-800">4 <span className="text-sm text-slate-500 font-semibold ml-2">Standard</span></h3>
          </div>
        ...
        <div className="glass-card p-6 rounded-2xl flex items-center justify-between animate-stagger-2 border-slate-200">
          <div>
            <p className="text-slate-500 text-sm font-semibold mb-1 uppercase tracking-wider">Profile Views</p>
            <h3 className="text-3xl font-bold text-slate-800">8,401 <span className="text-sm text-green-600 font-semibold ml-2">↑ 2%</span></h3>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/event-types" className="block opacity-0 animate-slide-up animate-stagger-1 group">
          <div className="glass-card p-8 rounded-2xl h-full flex flex-col relative overflow-hidden">
            ...
            <p className="text-slate-500 font-medium leading-relaxed">Create and manage your event types, duration, and rich details.</p>
          </div>
        </Link>
        
        <Link href="/availability" className="block opacity-0 animate-slide-up animate-stagger-2 group">
          <div className="glass-card p-8 rounded-2xl h-full flex flex-col relative overflow-hidden">
            ...
            <p className="text-slate-500 font-medium leading-relaxed">Configure your absolute master weekly availability hours.</p>
          </div>
        </Link>
        
        <Link href="/meetings" className="block opacity-0 animate-slide-up animate-stagger-3 group">
          <div className="glass-card p-8 rounded-2xl h-full flex flex-col relative overflow-hidden">
            ...
            <p className="text-slate-500 font-medium leading-relaxed">View and cancel your upcoming scheduled meetings dynamically.</p>
          </div>
        </Link>
      </div>
    </div>
