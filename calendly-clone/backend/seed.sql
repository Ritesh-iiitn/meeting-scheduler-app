...
-- Clear existing data
TRUNCATE TABLE bookings, availability, event_types, users RESTART IDENTITY CASCADE;
...
-- Insert Event Types
INSERT INTO event_types (user_id, title, slug, duration_minutes, description, color)
VALUES
(1, '15 Minute Meeting', '15-minute-meeting', 15, 'A quick 15-minute introductory catch-up.', '#006BFF'),
(1, '30 Minute Meeting', '30-minute-meeting', 30, 'Standard 30-minute discussion.', '#00A859'),
(1, '1 Hour Meeting', '1-hour-meeting', 60, 'Deep dive 1-hour session.', '#FF8D00');
